...
export function TransactionsView() {
    ...
    return (
        <div className="p-6 md:p-8 space-y-6 animate-in fade-in duration-500 pb-24">
            ...
            <div className="flex flex-col md:flex-row gap-4 bg-zinc-900/70 backdrop-blur-md p-4 rounded-2xl border border-zinc-800">
                <div className="relative flex-1">
                    ...
                    <input
                        ...
                        className="w-full pl-10 pr-4 py-2 bg-zinc-950 border border-zinc-800 rounded-xl text-sm text-white focus:outline-none focus:border-[#9AD93D]"
                    />
                </div>
                <div className="flex gap-2">
                    <select
                        ...
                        className="bg-zinc-950 border border-zinc-800 text-zinc-300 text-sm rounded-xl px-4 py-2 focus:outline-none focus:border-[#9AD93D]"
                    >
                                    ...
                                    <tr key={t.id} className="hover:bg-zinc-800/50 transition-colors">
                                        ...
                                        <td className="px-6 py-4">
                                            <span className={clsx(
                                                ...
                                                t.type === 'income' ? "bg-[#9AD93D]/10 text-[#9AD93D]" : "bg-red-500/10 text-red-400"
                                            )}>
                                        ...
                                        <td className="px-6 py-4 text-center">
                                            <div className="flex justify-center gap-2">
                                                <button
                                                    ...
                                                    className="text-zinc-500 hover:text-[#9AD93D] transition-colors p-2 hover:bg-zinc-800 rounded-lg"
                                                    title="Editar"
                                                >
                                                    <Pencil size={16} />
                                                </button>
